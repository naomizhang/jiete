/**
 +-------------------------------------------------------------------------------------------------------------
 * [全屏焦点图]插件 jquery.kinMaxShownews
 +-------------------------------------------------------------------------------------------------------------
 * @author   Mr.kin
 * @version  1.0
 * @file  	 jquery.kinMaxShownews-1.0.src.js
...
(function($){
	$.fn.kinMaxShownews = function(user_options){
			//默认设置
			var default_options = {
						//幻灯片高度 默认500
						height:350,				
						...
						button:{
								...
								normal:{width:'12px',height:'12px',lineHeight:'12px',right:'10px',bottom:'10px',fontSize:'10px',background:"#cccaca",color:"#b36e0b",textAlign:'center',marginRight:'8px',fontFamily:"Verdana",borderRadius:'30px',float:'right'},
								//当前 按钮样式
			...
			if($(this).length>1){
				$.error('kinMaxShownews error[More than one selected object]');
				return false;	
			}
