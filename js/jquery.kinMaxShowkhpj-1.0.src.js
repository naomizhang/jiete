/**
 +-------------------------------------------------------------------------------------------------------------
 * [全屏焦点图]插件 jquery.kinMaxShowkhpj
 +-------------------------------------------------------------------------------------------------------------
 * @author   Mr.kin
 * @version  1.0
 * @file  	 jquery.kinMaxShowkhpj-1.0.src.js
...
(function($){
	$.fn.kinMaxShowkhpj = function(user_options){
			//默认设置
			var default_options = {
						//幻灯片高度 默认500
						height:350,				
						...
						button:{
								...
								normal:{width:'12px',height:'12px',lineHeight:'12px',right:'520px',bottom:'10px',fontSize:'10px',background:"#cccaca",border:"1px solid #ffffff",color:"#b36e0b",textAlign:'center',marginRight:'8px',fontFamily:"Verdana",borderRadius:'30px',float:'right'},
								//当前 按钮样式
								focus:{background:"#e15943",color:"#000000"}
							},
			...
			if($(this).length>1){
				$.error('kinMaxShowkhpj error[More than one selected object]');
				return false;	
			}
