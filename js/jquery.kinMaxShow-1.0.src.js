	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'12px',height:'12px',lineHeight:'12px',right:'620px',bottom:'10px',fontSize:'10px',background:"#cccaca",border:"1px solid #ffffff",color:"#b36e0b",textAlign:'center',marginRight:'8px',fontFamily:"Verdana",borderRadius:'30px',float:'right'},
								//当前 按钮样式
